...
class ContentChild final : public PContentChild,
 ...
 public:
  ...
  bool Init(MessageLoop* aIOLoop, base::ProcessId aParentPid,
            IPC::Channel* aChannel, uint64_t aChildID, bool aIsForBrowser);
  ...
  virtual mozilla::ipc::IPCResult RecvGeolocationUpdate(
      const GeoPosition& somewhere) override;
  ...
  virtual mozilla::ipc::IPCResult RecvAppInfo(const nsCString& version,
                                              const nsCString& buildID,
                                              const nsCString& name,
                                              const nsCString& UAName,
                                              const nsCString& ID,
                                              const nsCString& vendor) override;
  ...
  virtual mozilla::ipc::IPCResult RecvDumpCodeCoverageCounters() override;

  virtual mozilla::ipc::IPCResult RecvResetCodeCoverageCounters() override;
